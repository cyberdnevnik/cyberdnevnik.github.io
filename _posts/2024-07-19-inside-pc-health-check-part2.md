...
So first argument is `hkey` where handle to an open registry key is placed or a constant value. Here `0xFFFFFFFF80000002` value is being passed which after searching around equates to `HKEY_LOCAL_MACHINE` predefined key ([https://www.dsource.org/projects/tango/ticket/820](https://www.dsource.org/projects/tango/ticket/820)).
